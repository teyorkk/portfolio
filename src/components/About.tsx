        ...
        <div className="bg-gray-50 rounded-2xl shadow-lg p-8 flex flex-col gap-10 md:flex-row items-center">
          ...
          <div className="flex-1">
            ...
            <p className="text-lg text-gray-700 mb-4">
              ...
              and functional web experiences. My journey in tech has equipped me
              with a strong foundation in modern web technologies and a drive to
              keep learning and growing.
            </p>
            <p className="text-md text-gray-600 mb-6">
              I enjoy solving problems, collaborating with others, and building
            ...
            <div className="mt-6 bg-gray-100 rounded-xl shadow p-6">
