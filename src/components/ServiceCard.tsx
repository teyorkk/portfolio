...
const ServiceCard = ({ service }: { service: Service }) => {
  return (
    <div
      className="group w-full h-40 sm:h-45 flex flex-col rounded-2xl border border-gray-200 bg-white p-3 sm:p-4 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-lg"
